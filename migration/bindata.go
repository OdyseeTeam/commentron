...
var _bintree = &bintree{nil, map[string]*bintree{
	"migration": &bintree{nil, map[string]*bintree{
		...
		"001_cascade_reaction_delete.sql": &bintree{migration001_cascade_reaction_deleteSql, map[string]*bintree{}},
		"002_pinned_comments.sql":         &bintree{migration002_pinned_commentsSql, map[string]*bintree{}},
		"003_blocked.sql":                 &bintree{migration003_blockedSql, map[string]*bintree{}},
		"004_flagged.sql":                 &bintree{migration004_flaggedSql, map[string]*bintree{}},
		"005_creator_settings.sql":        &bintree{migration005_creator_settingsSql, map[string]*bintree{}},
		"006_new_settings.sql":            &bintree{migration006_new_settingsSql, map[string]*bintree{}},
		"007_indices.sql":                 &bintree{migration007_indicesSql, map[string]*bintree{}},
		"008_comment_ranking.sql":         &bintree{migration008_comment_rankingSql, map[string]*bintree{}},
		"009_comment_fiat.sql":            &bintree{migration009_comment_fiatSql, map[string]*bintree{}},
		"010_shared_blocked_list.sql":     &bintree{migration010_shared_blocked_listSql, map[string]*bintree{}},
		"011_accepted_default.sql":        &bintree{migration011_accepted_defaultSql, map[string]*bintree{}},
		"012_appeals_for_all.sql":         &bintree{migration012_appeals_for_allSql, map[string]*bintree{}},
		"013_oauth.sql":                   &bintree{migration013_oauthSql, map[string]*bintree{}},
		"014_overlap_settings.sql":        &bintree{migration014_overlap_settingsSql, map[string]*bintree{}},
		"015_creationtime.sql":            &bintree{migration015_creationtimeSql, map[string]*bintree{}},
		"migration.go":                    &bintree{migrationMigrationGo, map[string]*bintree{}},
	}},
}}
