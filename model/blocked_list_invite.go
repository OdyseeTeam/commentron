...
func (o *BlockedListInvite) GetBlockedList() *BlockedList {
	if o == nil {
		return nil
	}
...
func (o *BlockedListInvite) GetInviterChannel() *Channel {
	if o == nil {
		return nil
	}

	return o.R.GetInviterChannel()
}
...
func (o *BlockedListInvite) GetInvitedChannel() *Channel {
	if o == nil {
		return nil
	}

	return o.R.GetInvitedChannel()
}
...
func (blockedListInviteL) LoadBlockedList(e boil.Executor, singular bool, maybeBlockedListInvite any, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (blockedListInviteL) LoadInviterChannel(e boil.Executor, singular bool, maybeBlockedListInvite any, mods queries.Applicator) error {
	var slice []*BlockedListInvite
	var object *BlockedListInvite
	...
	if singular {
		...
		args[object.InviterChannelID] = struct{}{}
		...
		for _, obj := range slice {
			...
			args[obj.InviterChannelID] = struct{}{}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (blockedListInviteL) LoadInvitedChannel(e boil.Executor, singular bool, maybeBlockedListInvite any, mods queries.Applicator) error {
	var slice []*BlockedListInvite
	var object *BlockedListInvite
	...
	if singular {
		...
		args[object.InvitedChannelID] = struct{}{}
		...
		for _, obj := range slice {
			...
			args[obj.InvitedChannelID] = struct{}{}
...
func (o *BlockedListInvite) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(blockedListInviteAllColumns, strmangle.SetIntersect(insert, update))
...
func (o *BlockedListInvite) Exists(exec boil.Executor) (bool, error) {
	return BlockedListInviteExists(exec, o.ID)
}
