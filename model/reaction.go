...
func (o *Reaction) GetChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (o *Reaction) GetComment() *Comment {
	if o == nil {
		return nil
	}
...
func (o *Reaction) GetReactionType() *ReactionType {
	if o == nil {
		return nil
	}

	return o.R.GetReactionType()
}
...
func (reactionL) LoadChannel(e boil.Executor, singular bool, maybeReaction any, mods queries.Applicator) error {
	var slice []*Reaction
	var object *Reaction
...
// loaded structs of the objects. This is for an N-1 relationship.
func (reactionL) LoadComment(e boil.Executor, singular bool, maybeReaction any, mods queries.Applicator) error {
	var slice []*Reaction
	var object *Reaction
...
// loaded structs of the objects. This is for an N-1 relationship.
func (reactionL) LoadReactionType(e boil.Executor, singular bool, maybeReaction any, mods queries.Applicator) error {
	var slice []*Reaction
	var object *Reaction
	...
	if singular {
		...
		args[object.ReactionTypeID] = struct{}{}
		...
		for _, obj := range slice {
			...
			args[obj.ReactionTypeID] = struct{}{}
	...
	query := NewQuery(
		...
		qm.WhereIn(`reaction_type.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Reaction) Exists(exec boil.Executor) (bool, error) {
	return ReactionExists(exec, o.ID)
}
