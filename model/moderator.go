...
func (o *Moderator) GetModChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (moderatorL) LoadModChannel(e boil.Executor, singular bool, maybeModerator any, mods queries.Applicator) error {
	var slice []*Moderator
...
func (o *Moderator) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(moderatorAllColumns, strmangle.SetIntersect(insert, update))
