...
func (o *ReactionType) GetReactions() ReactionSlice {
	if o == nil {
		return nil
	}
...
func (reactionTypeL) LoadReactions(e boil.Executor, singular bool, maybeReactionType any, mods queries.Applicator) error {
