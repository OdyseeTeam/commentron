...
func (o *CreatorSetting) GetCreatorChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (creatorSettingL) LoadCreatorChannel(e boil.Executor, singular bool, maybeCreatorSetting any, mods queries.Applicator) error {
...
func (o *CreatorSetting) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(creatorSettingAllColumns, strmangle.SetIntersect(insert, update))
...
func (o *CreatorSetting) Exists(exec boil.Executor) (bool, error) {
	return CreatorSettingExists(exec, o.ID)
}
