...
func (o *CommentClassification) GetComment() *Comment {
	if o == nil {
		return nil
	}
...
func (commentClassificationL) LoadComment(e boil.Executor, singular bool, maybeCommentClassification any, mods queries.Applicator) error {
...
func (o *CommentClassification) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(commentClassificationAllColumns, strmangle.SetIntersect(insert, update))
