...
func (o *BlockedListAppeal) GetBlockedList() *BlockedList {
	if o == nil {
		return nil
	}
...
func (o *BlockedListAppeal) GetBlockedEntry() *BlockedEntry {
	if o == nil {
		return nil
	}

	return o.R.GetBlockedEntry()
}
...
func (blockedListAppealL) LoadBlockedList(e boil.Executor, singular bool, maybeBlockedListAppeal any, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (blockedListAppealL) LoadBlockedEntry(e boil.Executor, singular bool, maybeBlockedListAppeal any, mods queries.Applicator) error {
	var slice []*BlockedListAppeal
	var object *BlockedListAppeal
