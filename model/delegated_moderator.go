...
func (o *DelegatedModerator) GetModChannel() *Channel {
	if o == nil {
		return nil
	}

	return o.R.GetModChannel()
}
...
func (o *DelegatedModerator) GetCreatorChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (delegatedModeratorL) LoadModChannel(e boil.Executor, singular bool, maybeDelegatedModerator any, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (delegatedModeratorL) LoadCreatorChannel(e boil.Executor, singular bool, maybeDelegatedModerator any, mods queries.Applicator) error {
	var slice []*DelegatedModerator
	var object *DelegatedModerator
